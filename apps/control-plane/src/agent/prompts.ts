...
import { z } from "zod";
import { actionSchema, expectPredicateSchema, type GrantTier } from "@sga/contract/public";
  ...
  anyOf: [
    {
      ...
      properties: { kind: { const: "element-present" }, target: DESCRIPTOR },
    },
    {
      type: "object",
      additionalProperties: false,
      required: ["kind", "target"],
      properties: { kind: { const: "element-absent" }, target: DESCRIPTOR },
    },
    {
      type: "object",
      additionalProperties: false,
    ...
    },
    {
      ...
      properties: { kind: { const: "url-matches" }, contains: { type: "string", minLength: 1 } },
    },
    {
      type: "object",
      additionalProperties: false,
  ...
  anyOf: [
    {
      ...
      additionalProperties: false,
      required: ["kind", "target"],
      properties: { kind: { const: "click" }, target: TARGET },
    },
    {
      type: "object",
      additionalProperties: false,
    ...
    },
    {
      ...
      properties: { kind: { const: "check" }, target: TARGET, checked: { type: "boolean" } },
    },
    {
      type: "object",
      additionalProperties: false,
      required: ["kind", "target"],
      properties: { kind: { const: "focus" }, target: TARGET },
    },
    {
      type: "object",
      additionalProperties: false,
      required: ["kind", "target"],
      properties: { kind: { const: "scrollIntoView" }, target: TARGET },
    },
    {
      type: "object",
      additionalProperties: false,
    ...
    },
    {
      ...
      additionalProperties: false,
      required: ["kind", "target"],
      properties: { kind: { const: "readBack" }, target: TARGET },
    },
  ],
} as const;
...
export const AGENT_TOOLS: Anthropic.Beta.Messages.BetaTool[] = [
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        outcome: { enum: ["completed", "not-completed"] },
...
export function buildTaskMessage(input: {
  ...
  return [
    ...
    "No adapter matched this site; you are working from perception alone.",
    "",
